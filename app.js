...
function sum(a, b) { //eslint-disable-line
    ...
    var sumNum =a+b;
    return [sumNum,`The sum of ${a} and ${b} is ${sumNum}.`];
}

// Here is the test for
 //sum(); //uncomment it to run it
testSum(4, 7);
...
var A=sum(a,b)[0];
var A1=sum(A,c)[0];
var B=multiply(a,b)[0];
var B1=multiply(B,c)[0];
return [A1,B1,`${a} and ${b} and ${c} sum to ${A1}.`,`The product of ${a} and ${b} and ${c} is ${B1}.`]
